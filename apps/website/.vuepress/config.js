  ...
  configureWebpack: {
    resolve: {
      alias: {
        ...
        '@cds/core': path.resolve('../../dist/core'),
        '@cds/core/alert': path.resolve('../../dist/core/alert'),
        '@cds/core/badge': path.resolve('../../dist/core/badge'),
        '@cds/core/button': path.resolve('../../dist/core/button'),
        '@cds/core/checkbox': path.resolve('../../dist/core/checkbox'),
        '@cds/core/datalist': path.resolve('../../dist/core/datalist'),
        '@cds/core/date': path.resolve('../../dist/core/date'),
        '@cds/core/file': path.resolve('../../dist/core/file'),
        '@cds/core/forms': path.resolve('../../dist/core/forms'),
        '@cds/core/icon': path.resolve('../../dist/core/icon'),
        '@cds/core/input': path.resolve('../../dist/core/input'),
        '@cds/core/modal': path.resolve('../../dist/core/modal'),
        '@cds/core/password': path.resolve('../../dist/core/password'),
        '@cds/core/radio': path.resolve('../../dist/core/radio'),
        '@cds/core/range': path.resolve('../../dist/core/range'),
        '@cds/core/search': path.resolve('../../dist/core/search'),
        '@cds/core/select': path.resolve('../../dist/core/select'),
        '@cds/core/tag': path.resolve('../../dist/core/tag'),
        '@cds/core/textarea': path.resolve('../../dist/core/textarea'),
        '@cds/core/time': path.resolve('../../dist/core/time'),
        '@cds/core/toggle': path.resolve('../../dist/core/toggle'),
