...
export class FullAsyncComponent {
   ...
   * model.
   */
  actionPopoverAnchor!: HTMLElement;
  ...
  showRowActions(event: Event, vm: TestVM) {
    this.selectedRow = vm;
    this.actionPopoverAnchor = event.target as HTMLElement;
  ...
  closeBatchActionDropdown() {
    this.batchActionAnchor = null as any;
  }

  closeFilterDropdown() {
    this.filterAnchor = null as any;
