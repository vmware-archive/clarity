...
gemini.suite('buttons', (child) => {
    ...
    gemini.suite('real-buttons', (child) => {
        child.setUrl('/buttons/real-button')
            .before((actions, find) => {
                actions.waitForElementToShow('main.content-area', WAIT_TIME);
            });

        var classes = [
            '.btn-primary', '.btn-success', '.btn-warning', '.btn-danger', '.btn-danger[disabled]',
            '.btn-outline', '.btn-success-outline', '.btn-info-outline', '.btn-warning-outline', '.btn-danger-outline',
            '.btn-outline[disabled]', '.btn-link', '.btn-link[disabled]', '.btn-sm', '.btn-sm[disabled]'
        ];
    ...
    gemini.suite('primary-button', (child) => {
        child.setUrl('/buttons/primary-button')
            .before((actions, find) => {
                actions.waitForElementToShow('main.content-area', WAIT_TIME);
            });
    ...
    gemini.suite('secondary-button', (child) => {
        child.setUrl('/buttons/secondary-button')
            .before((actions, find) => {
                actions.waitForElementToShow('main.content-area', WAIT_TIME);
            });
        captureButton('.btn');
    ...
    gemini.suite('tertiary-button', (child) => {
        child.setUrl('/buttons/tertiary-button')
            .before((actions, find) => {
                actions.waitForElementToShow('main.content-area', WAIT_TIME);
            });
    ...
    gemini.suite('inverse-button', (child) => {
        child.setUrl('/buttons/inverse-button')
            .before((actions, find) => {
                actions.waitForElementToShow('main.content-area', WAIT_TIME);
            });
    ...
    gemini.suite('button-states', (child) => {
        child.setUrl('/buttons/button-states')
            .before((actions, find) => {
                actions.waitForElementToShow('main.content-area', WAIT_TIME);
            });
    ...
    gemini.suite('button-sizes', (child) => {
        child.setUrl('/buttons/button-sizes')
            .before((actions, find) => {
                actions.waitForElementToShow('main.content-area', WAIT_TIME);
            });

        var classes = [
            '.btn', '.btn-primary', '.btn-success', '.btn-info', '.btn-warning', '.btn-danger', '.btn[disabled]',
            '.btn-sm', '.btn-primary.btn-sm', '.btn-success.btn-sm', '.btn-info.btn-sm', '.btn-warning.btn-sm',
            '.btn-danger.btn-sm', '.btn-sm[disabled]', '.btn-primary.btn-block', '.btn-success.btn-block'
        ];
