...
gemini.suite('alert', (child) => {
    ...
    gemini.suite('styles', (child) => {
        child.setUrl('/alert/static/styles')
            .before((actions, find) => {
    ...
    gemini.suite('sizes', (child) => {
        child.setUrl('/alert/static/sizes')
            .before((actions, find) => {
                actions.waitForElementToShow('div.content-area', WAIT_TIME);
                actions.wait(WAIT_LOAD_TIME);
            })
    ...
    gemini.suite('cards', (child) => {
        child.setUrl('/alert/static/cards')
            .before((actions, find) => {
    ...
    gemini.suite('modals', (child) => {
        child.setUrl('/alert/static/modals')
            .before((actions, find) => {
    ...
    gemini.suite('content-area', (child) => {
        child.setUrl('/alert/static/content-area')
            .before((actions, find) => {
                actions.waitForElementToShow('div.content-area', WAIT_TIME);
                actions.wait(WAIT_LOAD_TIME);
            })
    ...
    gemini.suite('app-level-static', (child) => {
        child.setUrl('/alert/static/app-level')
            .before((actions, find) => {
    ...
    gemini.suite('not-closable', (child) => {
        child.setUrl('/alert/angular/not-closable')
            .before((actions, find) => {
                actions.waitForElementToShow('div.content-area', WAIT_TIME);
                actions.wait(WAIT_LOAD_TIME);
            })
    ...
    gemini.suite('small', (child) => {
        child.setUrl('/alert/angular/small')
            .before((actions, find) => {
                actions.waitForElementToShow('div.content-area', WAIT_TIME);
                actions.wait(WAIT_LOAD_TIME);
            })
    ...
    gemini.suite('close-events', (child) => {
        child.setUrl('/alert/angular/close-events')
            .before((actions, find) => {
                actions.waitForElementToShow('div.content-area', WAIT_TIME);
                actions.wait(WAIT_LOAD_TIME);
    ...
    gemini.suite('success', (child) => {
        child.setUrl('/alert/angular/success')
            .before((actions, find) => {
                actions.waitForElementToShow('div.content-area', WAIT_TIME);
                actions.wait(WAIT_LOAD_TIME);
            })
    ...
    gemini.suite('app-level-angular', (child) => {
        child.setUrl('/alert/angular/app-level')
            .before((actions, find) => {
                actions.waitForElementToShow('div.main-container', WAIT_TIME);
                actions.wait(WAIT_LOAD_TIME);
            })
