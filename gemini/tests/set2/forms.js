...
gemini.suite('forms', child => {
  ...
  gemini.suite('form-horizontal-angular-grid', child => {
    child
      .setUrl('/forms/layout-horizontal-angular-grid')
      .before((actions, find) => {
        actions.setWindowSize(1200, 4000);
        actions.waitForElementToShow('.clr-form', WAIT_TIME);
      })
  ...
  gemini.suite('form-compact-angular-grid', child => {
    child
      .setUrl('/forms/layout-compact-angular-grid')
      .before((actions, find) => {
        actions.waitForElementToShow('.clr-form', WAIT_TIME);
      })
      .setCaptureElements('.clr-form')
  ...
  gemini.suite('form-input-group', child => {
    child
      ...
      .before((actions, find) => {
        actions.waitForElementToShow('.input-group-example', WAIT_TIME);
      })
      .setCaptureElements('.input-group-example')
      .capture('default');
  });
