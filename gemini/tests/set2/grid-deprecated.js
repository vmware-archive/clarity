...
gemini.suite('grid-deprecated', (child) => {
    ...
    gemini.suite('grid-columns', (child) => {
        child.setUrl('/grid-deprecated/grid-columns')
            .before((actions, find) => {
    ...
    gemini.suite('grid-column-stacking', (child) => {
        child.setUrl('/grid-deprecated/grid-column-stacking')
            .before((actions, find) => {
                actions.waitForElementToShow('.clr-example', WAIT_TIME);
                actions.wait(WAIT_LOAD_TIME);
            })
    ...
    gemini.suite('grid-column-offsetting', (child) => {
        child.setUrl('/grid-deprecated/grid-column-offsetting')
            .before((actions, find) => {
                actions.waitForElementToShow('.clr-example', WAIT_TIME);
                actions.wait(WAIT_LOAD_TIME);
            })
    ...
    gemini.suite('grid-column-push', (child) => {
        child.setUrl('/grid-deprecated/grid-column-push')
            .before((actions, find) => {
                actions.waitForElementToShow('.clr-example', WAIT_TIME);
                actions.wait(WAIT_LOAD_TIME);
            })
    ...
    gemini.suite('grid-column-pull', (child) => {
        child.setUrl('/grid-deprecated/grid-column-pull')
            .before((actions, find) => {
                actions.waitForElementToShow('.clr-example', WAIT_TIME);
                actions.wait(WAIT_LOAD_TIME);
            })
    ...
    gemini.suite('grid-auto-layout-1', (child) => {
        child.setUrl('/grid-deprecated/grid-auto-layout-1')
            .before((actions, find) => {
                actions.waitForElementToShow('.clr-example', WAIT_TIME);
                actions.wait(WAIT_LOAD_TIME);
            })
    ...
    gemini.suite('grid-auto-layout-2', (child) => {
        child.setUrl('/grid-deprecated/grid-auto-layout-2')
            .before((actions, find) => {
                actions.waitForElementToShow('.clr-example', WAIT_TIME);
                actions.wait(WAIT_LOAD_TIME);
            })
    ...
    gemini.suite('grid-items-vertical-alignment', (child) => {
        child.setUrl('/grid-deprecated/grid-items-vertical-alignment')
            .before((actions, find) => {
                actions.waitForElementToShow('.clr-example', WAIT_TIME);
                actions.wait(WAIT_LOAD_TIME);
            })
    ...
    gemini.suite('grid-items-individual-vertical-alignment', (child) => {
        child.setUrl('/grid-deprecated/grid-items-individual-vertical-alignment')
            .before((actions, find) => {
                actions.waitForElementToShow('.clr-example', WAIT_TIME);
                actions.wait(WAIT_LOAD_TIME);
            })
    ...
    gemini.suite('grid-items-horizontal-alignment', (child) => {
        child.setUrl('/grid-deprecated/grid-items-horizontal-alignment')
            .before((actions, find) => {
                actions.waitForElementToShow('.clr-example', WAIT_TIME);
                actions.wait(WAIT_LOAD_TIME);
            })
