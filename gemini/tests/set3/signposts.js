...
gemini.suite('signposts', (child) => {
    ...
    // TODO: Change the demo / gemini tests to use more targeted container elements (.clr-example) so that reference
    //       images are smaller and target only the element being tested
        .before((actions) => {
        ...
        .capture('hovered', function(actions, find) {
            actions.mouseMove(find('#topLeftTrigger'));
        })
