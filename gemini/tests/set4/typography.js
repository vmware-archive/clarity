...
gemini.suite('typography', (child) => {
    ...
    gemini.suite('typography-font-weight', (child) => {
        child.setUrl('/typography/typography-font-weight')
            .before((actions, find) => {
    ...
    gemini.suite('typography-headers', (child) => {
        child.setUrl('/typography/typography-headers')
            .before((actions, find) => {
                actions.waitForElementToShow('table', WAIT_TIME);
                actions.wait(WAIT_LOAD_TIME);
            })
    ...
    gemini.suite('typography-text', (child) => {
        child.setUrl('/typography/typography-text')
            .before((actions, find) => {
                actions.waitForElementToShow('table', WAIT_TIME);
                actions.wait(WAIT_LOAD_TIME);
            })
    ...
    gemini.suite('typography-links', (child) => {
        child.setUrl('/typography/typography-links')
            .before((actions, find) => {
