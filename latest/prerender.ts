...
const redirects = () => {
  [
    ...
    {from: join(BROWSER_FOLDER, 'documentation', 'code-highlight'), to: `${argv.base}/documentation/${environment.version}/code-highlight`},
    ...
    {from: join(BROWSER_FOLDER, 'documentation', 'input-fields'), to: `${argv.base}/documentation/${environment.version}/input-fields`},
