...
var ClrResponsiveNavigationService = (function () {
    function ClrResponsiveNavigationService() {
        ...
        this.registerNavSubject = new rxjs_1.BehaviorSubject([]);
        this.controlNavSubject = new rxjs_1.BehaviorSubject(new clrResponsiveNavControlMessage_1.ClrResponsiveNavControlMessage(clrResponsiveNavCodes_1.ClrResponsiveNavCodes.NAV_CLOSE_ALL, -999));
    }
