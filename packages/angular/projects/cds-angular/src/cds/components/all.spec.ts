...
@Component({
  template: `
    ...
    <cds-accordion-panel></cds-accordion-panel>
    ...
    <cds-checkbox-group></cds-checkbox-group>
    <cds-checkbox></cds-checkbox>
    <cds-datalist></cds-datalist>
    <cds-date></cds-date>
    <cds-divider></cds-divider>
    <cds-file></cds-file>
    <cds-control-action></cds-control-action>
    <cds-internal-control-group></cds-internal-control-group>
    <cds-internal-control-label></cds-internal-control-label>
    <cds-control-message></cds-control-message>
    <cds-form-group></cds-form-group>
    <cds-control></cds-control>
    <cds-internal-control-inline></cds-internal-control-inline>
    <cds-icon></cds-icon>
    <cds-input-group></cds-input-group>
    <cds-input></cds-input>
    ...
    <cds-modal></cds-modal>
    <cds-password></cds-password>
    <cds-progress-circle></cds-progress-circle>
    <cds-radio-group></cds-radio-group>
    <cds-radio></cds-radio>
    <cds-range></cds-range>
    ...
    <cds-time></cds-time>
    <cds-toggle-group></cds-toggle-group>
    <cds-toggle></cds-toggle>
  `,
})
class TestComponent {
