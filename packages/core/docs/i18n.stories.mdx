...
Clarity Core provides an i18n service to to change the text inside components to support different languages or easily customize strings inside the web component. Clarity Core i18n can be controlled in two different ways.
