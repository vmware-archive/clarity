...
<Meta title="Internal Preview Grid/Borders" />
...
The Grid provides three border styles, row (default), cell, and none.

```html
<cds-grid border="cell">
...
<Story id="stories-grid--border-cell" />

## Border Column

```html
<cds-grid border="column">
  <cds-grid-column>Host</cds-grid-column>
  <cds-grid-column>Status</cds-grid-column>
  <cds-grid-column>CPU</cds-grid-column>
  <cds-grid-column>Memory</cds-grid-column>
...
<Story id="stories-grid--border-column" />

## Border None

```html
<cds-grid border="none">
  <cds-grid-column>Host</cds-grid-column>
  <cds-grid-column>Status</cds-grid-column>
  <cds-grid-column>CPU</cds-grid-column>
  <cds-grid-column>Memory</cds-grid-column>
...
<Story id="stories-grid--border-none" />

## Border Stripe

```html
<cds-grid border="stripe">
  <cds-grid-column>Host</cds-grid-column>
  <cds-grid-column>Status</cds-grid-column>
  <cds-grid-column>CPU</cds-grid-column>
  <cds-grid-column>Memory</cds-grid-column>
...
<Story id="stories-grid--border-stripe" />
