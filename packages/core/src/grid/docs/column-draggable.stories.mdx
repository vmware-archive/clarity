...
<Meta title="Data Grid (Preview)/Column Draggable" />
...
<cds-grid>
  <cds-grid-column draggable="true">
    Host <cds-action-handle aria-label="sort host column"></cds-action-handle>
  </cds-grid-column>
  <cds-grid-column draggable="true">
    Status <cds-action-handle aria-label="sort status column"></cds-action-handle>
  </cds-grid-column>
  <cds-grid-column draggable="true">
    CPU <cds-action-handle aria-label="sort cpu column"></cds-action-handle>
  </cds-grid-column>
  <cds-grid-column draggable="true">
    Memory <cds-action-handle aria-label="sort memory column"></cds-action-handle>
  </cds-grid-column>
  <cds-grid-row>
