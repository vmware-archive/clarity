  ...
  class DemoColumnVisibility extends LitElement {
    ...
    render() {
      return html`
        ...
        <cds-dropdown closable orientation="top" id="column-visbility" ?hidden=${!this.columnAnchor} @closeChange=${(): void => this.columnAnchor = null} .anchor=${this.columnAnchor} position="top">
          <div cds-layout="p:md" style="min-width: 150px" closable orientation="top">
