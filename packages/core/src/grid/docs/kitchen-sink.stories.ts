  ...
  class DemoKitchenSink extends LitElement {
    ...
    render() {
      return html`
        ...
        <cds-dropdown id="column-visibility" closable orientation="top" ?hidden=${!this.state.columnsDropdownAnchor} @closeChange=${() => (this.state = { ...this.state, columnsDropdownAnchor: null as any })} .anchor=${this.state.columnsDropdownAnchor} position="top">
          <div cds-layout="vertical align:stretch p:md">
