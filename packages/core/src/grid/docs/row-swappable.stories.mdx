...
<Meta title="Internal Preview Grid/Row Swappable" />
...
<cds-grid>
  ...
  <cds-grid-row id="1" draggable="true">
    <cds-grid-cell>
      <cds-button-handle aria-label="sort host"></cds-button-handle>
    </cds-grid-cell>
...
<cds-grid>
  ...
  <cds-grid-row id="4" draggable="true">
    <cds-grid-cell>
      <cds-button-handle aria-label="sort row"></cds-button-handle>
    </cds-grid-cell>
