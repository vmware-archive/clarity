...
export function keyNavigationListController() {
  ...
  class DemoKeyNavigationList extends LitElement {
    ...
    @queryAll('button') keyListItems: NodeListOf<HTMLElement>;
...
export function keyNavigationListControllerVertical() {
  ...
  class DemoKeyNavigationListVertical extends LitElement {
    ...
    @queryAll('button') verticalKeyListItems: NodeListOf<HTMLElement>;
...
export function draggableListController() {
  @draggableList<DemoDraggableListController>()
...
export function ariaGridController() {
  ...
  class DemoAriaGridController extends LitElement {
      ...
      return html`
        <div class="grid">
          <div class="columnrowgroup">
            <div class="columnrow">
              ${DemoService.data.grid.columns.map(column => html`<div class="column" focusable>${column.label}</div>`)}
            </div>
          </div>
          <div class="rowgroup">
    ...
    static styles = [
      ...
      css`
        :host {
          --cds-alias-object-interaction-outline-offset: -2px;
          width: 800px;
