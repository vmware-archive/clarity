...
<Meta title="Components (Preview)/Circular Progress/Getting Started" />
...
<Preview>
  <Story id="components-preview-circular-progress-stories--status" />
</Preview>

## Spinner (Indeterminate Circular Progress)

<Preview>
  <Story id="components-preview-circular-progress-stories--spinner" />
</Preview>

## Custom

<Preview>
  <Story id="components-preview-circular-progress-stories--custom" />
</Preview>
