...
@Component({
  template: `
    <div class="container">
      <div *clrVirtualFor="let n of numbers" class="number" [class.wide]="n === 8">{{ n }}</div>
    </div>
  `,
  styles: [
    `
...
export default function (): void {
  describe('VirtualForOf directive', function () {
    beforeEach(fakeAsync(function (this: TestContext) {
      /*
    ...
    it('allows to reset the items', fakeAsync(function (this: TestContext) {
      this.scroll(1);
