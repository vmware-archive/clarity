...
export const ClrShapeShoppingCart =
  clrIconSVG(`<circle cx="13.33" cy="29.75" r="2.25" class="clr-i-outline clr-i-outline-path-1" />
...
export const ClrShapeECheck =
  clrIconSVG(`<rect class="clr-i-outline clr-i-outline-path-1" x="16" y="16" width="15" height="2"/>
