...
node -r dotenv/config -- ./node_modules/.bin/netlify deploy --json --dir=./dist/dev --message="V5 Branch - Dev App - $GITHUB_REF@$GITHUB_SHA" --site "v5.clarity.design" > ./logs/dev.netlify.json
