...
node -r dotenv/config -- ./node_modules/.bin/netlify deploy --json --dir=./dist/website --message="Angualr Branch - Website - $GITHUB_REF@$GITHUB_SHA" --site "angular.clarity.design" > ./logs/angular.clarity.design.netlify.json
