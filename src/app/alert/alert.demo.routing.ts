...
const ROUTES: Routes = [{
    ...
    children: [
        {path: "", redirectTo: "static", pathMatch: "full"}, {
            ...
            children: [
                {path: "", redirectTo: "styles", pathMatch: "full"}, {path: "styles", component: AlertStylesDemo},
                {path: "content-area", component: AlertContentAreaDemo}, {path: "cards", component: AlertCardsDemo},
                {path: "modals", component: AlertModalsDemo}, {path: "sizes", component: AlertSizesDemo},
