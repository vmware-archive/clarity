...
const FILES = [
    {name: "img_001.jpg", group: "image-file"}, {name: "mov_001.mov", group: "movie-file"},
    {name: "aud_001.mp4", group: "audio-file"}
];

@Component(
    {selector: "basic-droppable-demo", styleUrls: ["./drag-and-drop.demo.scss"], templateUrl: "./grouping.demo.html"})
