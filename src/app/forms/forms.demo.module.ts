...
@NgModule({
    ...
    declarations: [
        FormsDemo, FormsInputGroupDemo, FormsLayoutVerticalDemo, FormsLayoutHorizontalDemo, FormsLayoutCompactDemo,
        FormsLayoutVerticalGridDemo, FormsLayoutHorizontalGridDemo, FormsLayoutCompactGridDemo, FormsLayoutModalDemo,
        FormsTextDemo, FormsCheckboxDemo, FormsFileDemo, FormsRadioDemo, FormsSelectDemo, FormsTextareaDemo
    ],
    exports: [
        FormsDemo, FormsInputGroupDemo, FormsLayoutVerticalDemo, FormsLayoutHorizontalDemo, FormsLayoutCompactDemo,
        FormsLayoutVerticalGridDemo, FormsLayoutHorizontalGridDemo, FormsLayoutCompactGridDemo, FormsLayoutModalDemo,
