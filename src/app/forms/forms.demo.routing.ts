...
const ROUTES: Routes = [{
    ...
    component: FormsDemo,
    children: [
        {path: "", redirectTo: "form-fields", pathMatch: "full"}, {path: "form-fields", component: FormFieldsDemo},
        {path: "form-test", component: FormTestDemo}, {path: "form-validation", component: FormValidationDemo},
        {path: "form-compact", component: FormCompactDemo}, {path: "form-grid", component: FormGridDemo},
