...
const ROUTES: Routes = [{
    ...
    children: [
        {path: "", redirectTo: "default", pathMatch: "full"}, {path: "with-badges", component: LabelsWithBadgesDemo},
        {path: "status", component: LabelsStatusDemo}, {path: "clickable", component: LabelsClickableDemo},
        {path: "color-options", component: LabelsColorOptionsDemo}, {path: "default", component: LabelsDefaultDemo}
    ]
}];
