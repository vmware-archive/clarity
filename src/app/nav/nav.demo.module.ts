...
@NgModule({
    ...
    declarations: [
        NavDemo, HeadersDemo, NavsDemo, SidenavDemo, HeaderColorsDemo, HeaderTypesDemo, SubNavDemo, HeaderTypesOldDemo,
        ResponsiveNav1Demo, ResponsiveNav2Demo
    ],
    exports: [
        NavDemo, HeadersDemo, NavsDemo, SidenavDemo, HeaderColorsDemo, HeaderTypesDemo, SubNavDemo, ResponsiveNav1Demo,
        ResponsiveNav2Demo
    ]
})
