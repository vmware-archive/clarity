...
} from "./partially-nested-icon-menu/vertical-nav-partial-nested-icon-menus";
...
const ROUTES: Routes = [{
    ...
    children: [
        {path: "", redirectTo: "static", pathMatch: "full"}, {path: "static", component: VerticalNavStaticDemo},
        ...
        {path: "partial-nested-icon-menus", component: VerticalNavPartiallyNestedIconMenusDemo}, {
            ...
            children: [
                {path: "", redirectTo: "beatles", pathMatch: "full"}, {path: "beatles", component: BeatlesDemo},
                {path: "beatles/abbey-road", component: AbbeyRoadDemo},
                {path: "beatles/revolver", component: RevolverDemo},
                {path: "beatles/rubber-soul", component: RubberSoulDemo}, {path: "killers", component: KillersDemo},
                {path: "killers/hot-fuss", component: HotFussDemo},
                {path: "killers/day-and-age", component: DayAndAgeDemo},
                {path: "killers/sams-town", component: SamsTownDemo}, {path: "wikipedia", component: WikipediaDemo}
            ]
        },
        {
