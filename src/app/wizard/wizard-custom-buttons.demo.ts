...
<clr-wizard #wizard [(clrWizardOpen)]="open" [clrWizardSize]="'lg'">
    ...
    <clr-wizard-page>
        <template pageTitle>Page 1 with default buttons</template>
        <template pageNavTitle>Default buttons</template>
        ...
    </clr-wizard-page>

    <clr-wizard-page (clrWizardPageCustomButton)="doCustomClick($event)">

        <template pageTitle>Page 2 with custom buttons</template>
        <template pageNavTitle>Custom buttons</template>
        ...
    ...
    <clr-wizard-page>
        <template pageTitle>Page 3 with default buttons</template>
        <template pageNavTitle>Default buttons</template>
        ...
    </clr-wizard-page>

    <clr-wizard-page (clrWizardPageCustomButton)="doCustomClick($event)">
        <template pageTitle>Page 4 with custom finish</template>
        <template pageNavTitle>Custom buttons</template>
