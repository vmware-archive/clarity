...
const ROUTES: Routes = [{
    ...
    children: [
        {path: "", redirectTo: "basic", pathMatch: "full"}, {path: "basic", component: WizardBasicDemo},
        {path: "skip-page", component: WizardSkipPageDemo}, {path: "form-validation", component: WizardFormValidation},
        {path: "async-validation", component: WizardAsyncValidation},
        {path: "not-closable", component: WizardNotClosableDemo}, {path: "ghost-pages", component: WizardGhostsDemo},
        {path: "custom-buttons", component: WizardCustomButtonsDemo},
        {path: "header-actions", component: WizardHeaderActionsDemo},
        {path: "alt-cancel", component: WizardAltCancelDemo}, {path: "inline", component: WizardInlineDemo},
        {path: "jump-to", component: WizardJumpToDemo}, {path: "reset", component: WizardResetDemo},
        {path: "alt-next", component: WizardAltNextDemo}, {path: "force-forward", component: WizardForceForwardDemo},
