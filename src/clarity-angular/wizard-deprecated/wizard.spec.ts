...
@Component({
    template: `
    <clr-wizard-deprecated [(clrWizardOpen)]="open" [clrWizardClosable]="false">
        ...
        <clr-wizard-page-deprecated>Page1</clr-wizard-page-deprecated>
        <clr-wizard-page-deprecated>Page2</clr-wizard-page-deprecated>
        <clr-wizard-page-deprecated>Page3</clr-wizard-page-deprecated>
        <clr-wizard-page-deprecated>Page4</clr-wizard-page-deprecated>
    </clr-wizard-deprecated>
   `,
    viewProviders: [ScrollingService]
})
class BasicWizard {
    @ViewChild(WizardDeprecated) wizard: WizardDeprecated;
...
describe("Wizard", () => {
    ...
    describe("Basic", () => {
        ...
        it("initializes the correct property values", () => {
            ...
            let pageElements: HTMLElement[] =  compiled.querySelectorAll("clr-wizard-page-deprecated");
