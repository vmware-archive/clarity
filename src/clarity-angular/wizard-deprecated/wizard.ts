...
export class WizardDeprecated extends Tabs {
    id: string;

    @ContentChildren(WizardStep) wizardStepChildren: QueryList<WizardStep>;
    @ContentChildren(WizardPageDeprecated) wizardPageChildren: QueryList<WizardPageDeprecated>;
    ...
    // The current page
    currentPage: WizardPageDeprecated = null;
    ...
    ngAfterContentInit(): void {
        ...
        this.wizardPageChildren.forEach((wizardPage: WizardPageDeprecated, index: number): void => {
    ...
    get tabContents(): WizardPageDeprecated[] {
        return this.wizardPageChildren.filter((wizardPage: WizardPageDeprecated) => {
    ...
    _next(event?: any): void {
        ...
        let page: WizardPageDeprecated = this.tabContents[i];
    ...
    selectTab(wizardNav: WizardStep): void {
        ...
        let page: WizardPageDeprecated = this.currentTabContent as WizardPageDeprecated;
        ...
        this.wizardStepChildren.forEach((wizardStep: WizardStep, index: number) => {
            if (wizardStep.id === tabId) {
                ...
                if (index < this.wizardPageChildren.length) {
                    let children: WizardPageDeprecated[] = this.wizardPageChildren.toArray();
