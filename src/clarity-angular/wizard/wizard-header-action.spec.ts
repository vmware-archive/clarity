...
@Component({
    template: `
        ...
        <clr-wizard-header-action #identified [id]="myId"></clr-wizard-header-action>
        ...
        <clr-wizard-header-action #clicker [id]="'gotklikz'" 
        ...
        describe("Template API", () => {
            ...
            describe("actionClicked", () => {
                it("should emit event as expected on click", () => {
                    ...
                    expect(testComponent.lastClickedHeaderAction).toBe("clr-wizard-header-action-gotklikz");
                });
