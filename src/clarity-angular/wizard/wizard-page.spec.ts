...
@Component({
    template: `
        <clr-wizard-page>
            <template pageTitle>Mandatory Title</template>
            Hello moto
        </clr-wizard-page>
        <clr-wizard-page>
            <template pageTitle>Mandatory Title</template>
            <template pageNavTitle>Optional nav title</template>
    ...
    describe("WizardPage", () => {
        ...
        @Component({
            template: `
                ...
                >
                    <template pageTitle>Tests of page nav inputs and outputs</template>
                </clr-wizard-page>
                <clr-wizard-page #lifecycle>
                    <template pageTitle>Tests for lifecycle outputs and event handlers</template>
                </clr-wizard-page>
                <clr-wizard-page #other
                    [id]="testId"
                    (clrWizardPageOnLoad)="onLoadCheck($event)"
                >
                    <template pageTitle>Other template API tests</template>
                </clr-wizard-page>
            `
        })
        ...
        @Component({
            ...
            <clr-wizard #viewTestWizard [(clrWizardOpen)]="open">
                ...
                >
                    <template pageTitle>View Page 1</template>
                ...
                <clr-wizard-page #viewTestWizardPageTwo
                    ...
                    <template pageTitle>View Page 2</template>
                    <p>{{projector}}</p>
                </clr-wizard-page>

                <clr-wizard-page #viewTestWizardPageThree
                    [(clrWizardPagePreviousDisabled)]="disablePrevious">
                    <template pageTitle>View Page 3</template>
                    <template pageNavTitle>short title</template>
                ...
                >
                    <template pageTitle>View Page 4</template>
