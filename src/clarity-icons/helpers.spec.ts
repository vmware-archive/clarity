...
// TODO: open question... should we make whitespace removal part of the icon
// parsing???
...
export function testAllShapes(clarityIcons: any, expectedShapes: any): void {
  expect(Object.keys(clarityIcons.get()).length)
      .toEqual(Object.keys(expectedShapes).length);
...
export function resetShapes(): void {
  ...
  // Removes all shapes from Clarity Icons, but adds the icons from CoreShapes
  // back at the end because the CoreShapes icons are added by default by
  // ClarityIcons.
