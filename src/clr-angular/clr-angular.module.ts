...
@NgModule({
    exports: [
        ClrButtonModule, ClrCodeModule, ClrConditionalModule, ClrDataModule, ClrDragAndDropModule, ClrEmphasisModule,
        ClrFocusTrapModule, ClrFormsModule, ClrIconModule, ClrIfExpandModule, ClrLayoutModule, ClrLoadingModule,
        ClrModalModule, ClrPopoverModule, ClrWizardModule
    ]
})
