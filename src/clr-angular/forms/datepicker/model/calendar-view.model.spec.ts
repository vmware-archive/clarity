...
export default function(): void {
    describe("CalendarViewModel", function() {
        ...
        it("generates a CalendarView w.r.t to the first day of the week", () => {
            ...
            const prevFr: number[] = [];
            const currFr: number[] = Array(31).fill(0).map((e, i) => i + 1);
            const nextFr: number[] = Array(11).fill(0).map((e, i) => i + 1);
            ...
            const currRandom: number[] = Array(31).fill(0).map((e, i) => i + 1);
            const nextRandom: number[] = Array(8).fill(0).map((e, i) => i + 1);
