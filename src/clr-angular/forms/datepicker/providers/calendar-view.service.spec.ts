...
import {Component, DebugNode, ElementRef, EventEmitter, NgZone} from "@angular/core";
import {ComponentFixture, TestBed} from "@angular/core/testing";

export default function () {
    describe("Calendar View Service", () => {
        let calendarViewService: CalendarViewService;
        let fixture: ComponentFixture<any>;
        let mockNgZone: MockNgZone;

        beforeEach(() => {
            mockNgZone = new MockNgZone();
            calendarViewService = new CalendarViewService(mockNgZone);
        ...
        it("Focuses on the button if the button has a tabindex of 0", () => {
            ...
            calendarViewService.focusCell(compInstance.elementRef);
