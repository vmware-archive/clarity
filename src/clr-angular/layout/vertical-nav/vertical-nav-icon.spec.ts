    ...
    describe("Vertical Nav Icons", () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule(
                {declarations: [ClrVerticalNavIcon, TestComponent], providers: [VerticalNavIconService]});
        ...
        it("adds a nav-icon class to the host", () => {
            expect(fixture.debugElement.componentInstance.navIcon.nativeElement.classList.contains("nav-icon"))
                .toBeTruthy();
