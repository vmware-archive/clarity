    ...
    describe("With ClrDraggable", function() {
        ...
        beforeEach(function() {
            TestBed.configureTestingModule(
                {imports: [ClrDragAndDropModule, NoopAnimationsModule], declarations: [WithDraggableTest]});
        ...
        describe("View", function() {
            ...
            it("should add being-dragged class to draggable being dragged", function() {
                ...
                expect(draggableQueries.length)
                    .toBe(1, `Only one draggable should have the "being-dragged" class at a time.`);
...
@Component({
    styles: [`
        ...
        `],
    template:
        `<button clrDraggable>draggable button</button><div class="draggable-test-state" clrGroup="draggable-1" [clrDraggable]="mockDataPayload">draggable div</div>
