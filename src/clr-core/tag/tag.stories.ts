...
export const closable = () => {
  return html`
    ...
    <div>
      <cds-tag aria-label="Closable example of a tag with an icon" color="gray" closable><cds-icon shape="user"></cds-icon>Default</cds-tag>
      <cds-tag aria-label="Closable example of a blue tag with an icon" color="blue" closable><cds-icon shape="user"></cds-icon>Blue</cds-tag>
      <cds-tag aria-label="Closable example of an orange tag with an icon" color="orange" closable><cds-icon shape="user"></cds-icon>Orange</cds-tag>
    </div>
  `;
};
...
export const tagsAndIcons = () => {
  ...
  <div>
    ...
    <cds-tag readonly color="gray"><cds-icon shape="user" .solid=${solidIcon}></cds-icon>Default <cds-badge>1</cds-badge></cds-tag>
    <cds-tag readonly color="purple"><cds-icon shape="user" .solid=${solidIcon}></cds-icon>Purple <cds-badge>2</cds-badge></cds-tag>
    <cds-tag readonly color="blue"><cds-icon shape="user" .solid=${solidIcon}></cds-icon>Blue <cds-badge>3</cds-badge></cds-tag>
    <cds-tag readonly color="orange"><cds-icon shape="user" .solid=${solidIcon}></cds-icon>Orange <cds-badge>12</cds-badge></cds-tag>
    <cds-tag readonly color="light-blue"><cds-icon shape="user" .solid=${solidIcon}></cds-icon>Light Blue <cds-badge>15</cds-badge></cds-tag>
  </div>
  <div>
    ...
    <cds-tag readonly status="info"><cds-icon shape="info-standard" .solid=${solidIcon}></cds-icon>Info <cds-badge status="info">1</cds-badge></cds-tag>
    <cds-tag readonly status="success"><cds-icon shape="info-standard" .solid=${solidIcon}></cds-icon>Success <cds-badge status="success">2</cds-badge></cds-tag>
    <cds-tag readonly status="warning"><cds-icon shape="info-standard" .solid=${solidIcon}></cds-icon>Warning <cds-badge status="warning">3</cds-badge> </cds-tag>
    <cds-tag readonly status="danger"><cds-icon shape="info-standard" .solid=${solidIcon}></cds-icon>Danger <cds-badge status="danger">12</cds-badge></cds-tag>
  </div>
  `;
};
