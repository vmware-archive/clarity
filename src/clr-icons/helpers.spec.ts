...
export function giveAngleShapeTitle(titleId: string, titleTxt: string) {
    return `${
        clrIconSVG(
            `<path class="clr-i-outline clr-i-outline-path-1" d="M29.52,22.52,18,10.6,6.48,22.52a1.7,1.7,0,0,0,2.45,2.36L18,15.49l9.08,9.39a1.7,1.7,0,0,0,2.45-2.36Z"></path>`)}<span class="is-off-screen" id="${
        titleId}">${titleTxt}</span>`;
}
