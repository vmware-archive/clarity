...
const ClrShapeCalculatorSVG = clrIconSVG(
...
const ClrShapeShoppingBagSVG = clrIconSVG(
...
const ClrShapePiggyBankSVG = clrIconSVG(
...
const ClrShapeShoppingCartSVG = clrIconSVG(`<circle cx="13.33" cy="29.75" r="2.25" class="clr-i-outline clr-i-outline-path-1" />
...
const ClrShapeWalletSVG = clrIconSVG(
...
const ClrShapeStoreSVG = clrIconSVG(
...
const ClrShapeEuroSVG = clrIconSVG(
...
const ClrShapeDollarSVG = clrIconSVG(
...
const ClrShapeCreditCardSVG = clrIconSVG(
...
const ClrShapeBankSVG = clrIconSVG(
...
const ClrShapeDollarBillSVG = clrIconSVG(
...
const ClrShapeECheckSVG = clrIconSVG(`<rect class="clr-i-outline clr-i-outline-path-1" x="16" y="16" width="15" height="2"/>
...
const ClrShapePoundSVG = clrIconSVG(
...
const ClrShapeRupeeSVG = clrIconSVG(
...
const ClrShapeWonSVG = clrIconSVG(
...
const ClrShapeYenSVG = clrIconSVG(
...
const ClrShapeBitcoinSVG = clrIconSVG(
...
const ClrShapeCoinBagSVG = clrIconSVG(
...
const ClrShapePesoSVG = clrIconSVG(
...
const ClrShapeRubleSVG = clrIconSVG(
...
Object.defineProperty(ClrShapePiggyBank, 'savings', descriptorConfig(ClrShapePiggyBankSVG));

export const ClrCommerceSet: any = {
  ...ClrShapeCalculator,
  ...ClrShapePiggyBank,
  ...ClrShapeShoppingBag,
