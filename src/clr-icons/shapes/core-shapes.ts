...
`),
    ...
    "exclamation-triangle": clrIconSVG(`
    ...
    "ellipsis-horizontal": clrIconSVG(`
...
Object.defineProperty(coreShapes, "event", descriptorConfig(coreShapes.event));
