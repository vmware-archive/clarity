...
export const ClrShapePlaySVG = clrIconSVG(
...
export const ClrShapePauseSVG = clrIconSVG(
...
export const ClrShapeStepForwardSVG = clrIconSVG(
...
export const ClrShapeStopSVG = clrIconSVG(
...
export const ClrShapePowerSVG = clrIconSVG(
...
export const ClrShapeRewindSVG = clrIconSVG(
...
export const ClrShapeFastForwardSVG = clrIconSVG(
...
export const ClrShapeCameraSVG = clrIconSVG(
...
export const ClrShapeVideoCameraSVG = clrIconSVG(
...
export const ClrShapeShuffleSVG = clrIconSVG(
...
export const ClrShapeVolumeDownSVG = clrIconSVG(
...
export const ClrShapeVolumeUpSVG = clrIconSVG(
...
export const ClrShapeVolumeMuteSVG = clrIconSVG(
...
export const ClrShapeHeadphonesSVG = clrIconSVG(
...
export const ClrShapeFilmStripSVG = clrIconSVG(
...
export const ClrShapeMusicNoteSVG = clrIconSVG(`<path class="clr-i-outline clr-i-outline-path-1"
...
export const ClrShapeImageGallerySVG = clrIconSVG(
...
export const ClrShapeReplayAllSVG = clrIconSVG(
...
export const ClrShapeReplayOneSVG = clrIconSVG(
...
export const ClrShapeVideoGallerySVG = clrIconSVG(
...
export const ClrShapeMicrophoneSVG = clrIconSVG(`<path d="M18,24c3.9,0,7-3.1,7-7V9c0-3.9-3.1-7-7-7s-7,3.1-7,7v8C11,20.9,14.1,24,18,24z M13,9c0-2.8,2.2-5,5-5s5,2.2,5,5v8
...
export const ClrShapeMicrophoneMuteSVG = clrIconSVG(`<path d="M30,17h-2c0,1.8-0.5,3.5-1.4,5l1.5,1.5C29.3,21.5,29.9,19.3,30,17z" class="clr-i-outline clr-i-outline-path-1" /><path d="M18,4c2.8,0,5,2.2,5,5v8c0,0.4-0.1,0.8-0.2,1.2l1.6,1.6c0.4-0.9,0.6-1.8,0.6-2.8V9c0-3.9-3.2-7-7.1-6.9
...
export const ClrShapePlay = { play: ClrShapePlaySVG };
export const ClrShapePause = { pause: ClrShapePauseSVG };
export const ClrShapeStepForward = { 'step-forward': ClrShapeStepForwardSVG };
export const ClrShapeStop = { stop: ClrShapeStopSVG };
export const ClrShapePower = { power: ClrShapePowerSVG };
export const ClrShapeRewind = { rewind: ClrShapeRewindSVG };
export const ClrShapeFastForward = { 'fast-forward': ClrShapeFastForwardSVG };
export const ClrShapeCamera = { camera: ClrShapeCameraSVG };
export const ClrShapeVideoCamera = { 'video-camera': ClrShapeVideoCameraSVG };
export const ClrShapeShuffle = { shuffle: ClrShapeShuffleSVG };
export const ClrShapeVolumeUp = { 'volume-up': ClrShapeVolumeUpSVG };
export const ClrShapeVolumeDown = { 'volume-down': ClrShapeVolumeDownSVG };
export const ClrShapeVolumeMute = { 'volume-mute': ClrShapeVolumeMuteSVG };
export const ClrShapeHeadphones = { headphones: ClrShapeHeadphonesSVG };
export const ClrShapeFilmStrip = { 'film-strip': ClrShapeFilmStripSVG };
export const ClrShapeMusicNote = { 'music-note': ClrShapeMusicNoteSVG };
export const ClrShapeImageGallery = { 'image-gallery': ClrShapeImageGallerySVG };
export const ClrShapeReplayAll = { 'replay-all': ClrShapeReplayAllSVG };
export const ClrShapeReplayOne = { 'replay-one': ClrShapeReplayOneSVG };
export const ClrShapeVideoGallery = { 'video-gallery': ClrShapeVideoGallerySVG };
export const ClrShapeMicrophone = { microphone: ClrShapeMicrophoneSVG };
export const ClrShapeMicrophoneMute = { 'microphone-mute': ClrShapeMicrophoneMuteSVG };
...
export const MediaShapes: any = {
  ...
  ...ClrShapeFilmStrip,
  ...ClrShapeMusicNote,
  ...ClrShapeImageGallery,
  ...ClrShapeReplayAll,
  ...ClrShapeReplayOne,
  ...ClrShapeVideoGallery,
  ...ClrShapeMicrophone,
  ...ClrShapeMicrophoneMute,
};
