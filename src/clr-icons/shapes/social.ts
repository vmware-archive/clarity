...
import { ClrShapeCalendar, ClrShapeEvent } from './core';
import { descriptorConfig } from '../utils/descriptor-config';

/* tslint:disable:variable-name */
const ClrShapeShareSVG = clrIconSVG(
...
const ClrShapeStarSVG = clrIconSVG(
...
const ClrShapeHalfStarSVG = clrIconSVG(
...
const ClrShapeBookmarkSVG = clrIconSVG(
...
const ClrShapeEnvelopeSVG = clrIconSVG(
...
const ClrShapeTasksSVG = clrIconSVG(
...
const ClrShapeFlagSVG = clrIconSVG(
...
const ClrShapeInboxSVG = clrIconSVG(
...
const ClrShapeHeartSVG = clrIconSVG(
...
const ClrShapeHeartBrokenSVG = clrIconSVG(
...
const ClrShapeTalkBubblesSVG = clrIconSVG(
...
const ClrShapeChatBubbleSVG = clrIconSVG(
...
const ClrShapePictureSVG = clrIconSVG(
...
const ClrShapeHappyFaceSVG = clrIconSVG(
...
const ClrShapeNeutralFaceSVG = clrIconSVG(`<path d="M24.05,22.06h-12a1,1,0,0,0,0,2h12a1,1,0,0,0,0-2Z" class="clr-i-outline clr-i-outline-path-1"/>
...
const ClrShapeSadFaceSVG = clrIconSVG(
  `<path d="M18,2A16,16,0,1,0,34,18,16,16,0,0,0,18,2Zm0,30A14,14,0,1,1,32,18,14,14,0,0,1,18,32Z" class="clr-i-outline clr-i-outline-path-1"/>
...
const ClrShapeThumbsUpSVG = clrIconSVG(
...
const ClrShapeThumbsDownSVG = clrIconSVG(
...
Object.defineProperty(ClrShapeStar, 'favorite', descriptorConfig(ClrShapeStarSVG));
Object.defineProperty(ClrShapeEnvelope, 'email', descriptorConfig(ClrShapeEnvelopeSVG));
Object.defineProperty(ClrShapeCalendar, 'date', descriptorConfig(ClrShapeCalendar.calendar));

export const ClrSocialSet: any = {
  ...ClrShapeShare,
  ...ClrShapeStar,
  ...ClrShapeHalfStar,
  ...ClrShapeBookmark,
