...
export const ClrShapeNodeClusterGroup = clrIconSVG(
...
export const ClrShapeNodeCluster = clrIconSVG(
...
export const TechnologyShapes: any = {
  ...
  'node-cluster-group': ClrShapeNodeClusterGroup,
  'node-cluster': ClrShapeNodeCluster,
