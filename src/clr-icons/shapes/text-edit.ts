...
export const ClrShapeBoldSVG = clrIconSVG(
...
export const ClrShapeBulletListSVG = clrIconSVG(
...
export const ClrShapeCenterTextSVG = clrIconSVG(
...
export const ClrShapeCheckboxListSVG = clrIconSVG(
...
export const ClrShapeFontSizeSVG = clrIconSVG(
...
export const ClrShapeAlignCenterSVG = clrIconSVG(
...
export const ClrShapeAlignLeftSVG = clrIconSVG(
...
export const ClrShapeAlignRightSVG = clrIconSVG(
...
export const ClrShapeItalicSVG = clrIconSVG(
...
export const ClrShapeJustifyTextSVG = clrIconSVG(
...
export const ClrShapeAlignLeftTextSVG = clrIconSVG(
...
export const ClrShapeNumberListSVG = clrIconSVG(
...
export const ClrShapePaintRollerSVG = clrIconSVG(
...
export const ClrShapeBlockQuoteSVG = clrIconSVG(
...
export const ClrShapeAlignRightTextSVG = clrIconSVG(
...
export const ClrShapeTextSVG = clrIconSVG(
...
export const ClrShapeUnderlineSVG = clrIconSVG(
...
export const ClrShapeAlignBottomSVG = clrIconSVG(
...
export const ClrShapeAlignMiddleSVG = clrIconSVG(
...
export const ClrShapeAlignTopSVG = clrIconSVG(
...
export const ClrShapeLanguageSVG = clrIconSVG(`<path d="M30,3H14v5h2V5h14c0.6,0,1,0.4,1,1v11c0,0.6-0.4,1-1,1H17v7h-5.3L8,27.9V25H5c-0.6,0-1-0.4-1-1V13c0-0.6,0.4-1,1-1h13v-2H5
...
export const ClrShapeBold = { bold: ClrShapeBoldSVG };
export const ClrShapeBulletList = { 'bullet-list': ClrShapeBulletListSVG };
export const ClrShapeCheckboxList = { 'checkbox-list': ClrShapeCheckboxListSVG };
export const ClrShapeNumberList = { 'number-list': ClrShapeNumberListSVG };
export const ClrShapeFontSize = { 'font-size': ClrShapeFontSizeSVG };
export const ClrShapeItalic = { italic: ClrShapeItalicSVG };
export const ClrShapeJustifyText = { 'justify-text': ClrShapeJustifyTextSVG };
export const ClrShapeCenterText = { 'center-text': ClrShapeCenterTextSVG };
export const ClrShapeAlignLeftText = { 'align-left-text': ClrShapeAlignLeftTextSVG };
export const ClrShapeAlignRightText = { 'align-right-text': ClrShapeAlignRightTextSVG };
export const ClrShapePaintRoller = { 'paint-roller': ClrShapePaintRollerSVG };
export const ClrShapeBlockQuote = { 'block-quote': ClrShapeBlockQuoteSVG };
export const ClrShapeText = { text: ClrShapeTextSVG };
export const ClrShapeUnderline = { underline: ClrShapeUnderlineSVG };
export const ClrShapeAlignCenter = { 'align-center': ClrShapeAlignCenterSVG };
export const ClrShapeAlignLeft = { 'align-left': ClrShapeAlignLeftSVG };
export const ClrShapeAlignRight = { 'align-right': ClrShapeAlignRightSVG };
export const ClrShapeAlignBottom = { 'align-bottom': ClrShapeAlignBottomSVG };
export const ClrShapeAlignMiddle = { 'align-middle': ClrShapeAlignMiddleSVG };
export const ClrShapeAlignTop = { 'align-top': ClrShapeAlignTopSVG };
export const ClrShapeLanguage = { language: ClrShapeLanguageSVG };
...
export const TextEditShapes: any = {
  ...
  ...ClrShapeJustifyText,
  ...ClrShapeCenterText,
  ...ClrShapeAlignLeftText,
  ...ClrShapeAlignRightText,
  ...ClrShapePaintRoller,
  ...ClrShapeBlockQuote,
  ...ClrShapeText,
  ...ClrShapeUnderline,
