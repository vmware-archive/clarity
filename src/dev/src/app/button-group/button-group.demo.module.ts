...
import { ClrIconModule, ClrButtonGroupModule, ClrLoadingButtonModule, ClrCheckboxModule } from '@clr/angular';
...
@NgModule({
  imports: [CommonModule, ClrIconModule, ClrButtonGroupModule, ClrLoadingButtonModule, ClrCheckboxModule, ROUTING],
  declarations: [
