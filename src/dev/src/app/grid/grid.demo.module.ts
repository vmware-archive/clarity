...
@NgModule({
    ...
    declarations: [
        GridDemo, GridColumnsDemo, GridColumnStackingDemo, GridColumnOffsettingDemo, GridAutoLayoutEqualWidthDemo,
        GridOneColWidthDemo, GridVariableWidthContentDemo, GridAutoLayoutEqualWidthMultiRowDemo, GridNoGuttersDemo,
        GridHorizontalAlignmentDemo, GridVerticalAlignmentDemo, GridColumnWrappingDemo, GridOrderingDemo,
        GridNestingDemo
    ],
    exports: [
        GridDemo, GridColumnsDemo, GridColumnStackingDemo, GridColumnOffsettingDemo, GridAutoLayoutEqualWidthDemo,
