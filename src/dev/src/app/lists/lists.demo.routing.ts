...
const ROUTES: Routes = [{
    ...
    component: ListsDemo,
    children: [
        {path: "", redirectTo: "lists-ul", pathMatch: "full"}, {path: "lists-ul", component: ListsUlDemo},
        {path: "lists-ol", component: ListsOlDemo}, {path: "lists-in-cards", component: ListsInCardsDemo},
        {path: "lists-unstyled", component: ListsUnstyledDemo}, {path: "lists-mixed", component: ListsMixedDemo},
