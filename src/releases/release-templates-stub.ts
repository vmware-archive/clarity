...
export const TEMPLATES = {
  '0.9.3': require('./0.9/0.9.3.html'),
  '0.9.2': require('./0.9/0.9.2.html'),
  '0.9.1': require('./0.9/0.9.1.html'),
  '0.9.0': require('./0.9/0.9.0.html'),

  '0.8.18': require('./0.8/0.8.18.html'),
  '0.8.17': require('./0.8/0.8.17.html'),
  '0.8.16': require('./0.8/0.8.16.html'),
  '0.8.15': require('./0.8/0.8.15.html'),
  '0.8.14': require('./0.8/0.8.14.html'),
  '0.8.13': require('./0.8/0.8.13.html'),
  '0.8.12': require('./0.8/0.8.12.html'),
  '0.8.11': require('./0.8/0.8.11.html'),
  '0.8.10': require('./0.8/0.8.10.html'),
  '0.8.9': require('./0.8/0.8.9.html'),
  '0.8.8': require('./0.8/0.8.8.html'),
  '0.8.7': require('./0.8/0.8.7.html'),
  '0.8.6': require('./0.8/0.8.6.html'),
  '0.8.5': require('./0.8/0.8.5.html'),
  '0.8.4': require('./0.8/0.8.4.html'),
