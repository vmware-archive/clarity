...
function addDeclarationToNgModule(options: ComponentOptions, imports: string, moduleName: string,
                                  packageName: string): Rule {
    return (host: Tree) => {
...
export default function(options: ComponentOptions): Rule {
    return (host: Tree, context: SchematicContext) => {
        ...
        return chain([
            ...
            addDeclarationToNgModule(options, "imports", "BrowserAnimationsModule",
