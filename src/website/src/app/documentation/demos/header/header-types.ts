    ...
    <div class="header-actions">
        <clr-dropdown>
            <button class="nav-icon" 
                    clrDropdownTrigger
                    clrAriaLabelDropdownOpen="Open menu settings dropdown"
                    clrAriaLabelDropdownClose="Close menu settings dropdown">
                <clr-icon shape="cog"></clr-icon>
    ...
    <div class="header-actions">
        <clr-dropdown>
            <button class="nav-text" 
                    clrDropdownTrigger
                    clrAriaLabelDropdownOpen="Open user profile dropdown"
                    clrAriaLabelDropdownClose="Close user profile dropdown">
                john.doe@vmware.com
                <clr-icon shape="caret down"></clr-icon>
            </button>
            <clr-dropdown-menu *clrIfOpen clrPosition="bottom-right">
